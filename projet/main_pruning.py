...
for f in os.listdir(f"./{dataset}/models/models_regularized"):
    ...
    scheduler = f[findnth_left(f, "_", 8):]
    ...
    pruning_Hyperparameters = PruningHyperparameters(learning_rate, weight_decay, momentum,
                                                     loss_function, gradient_method, model_name,
                                                     scheduler, pruning_rate, pruning_type)
