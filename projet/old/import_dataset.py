...
# A noter: ici, on ne fait que changer la même image, on ne met pas différentes
# versions de l'image, ce n'est pas vraiment du data augmentation
# Il aurait fallu prendre le dataset, le multiplier, et appliquer cette
# transformation (flip, crop) sur la moitié du dataset par exemple
