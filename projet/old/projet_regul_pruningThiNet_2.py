        ...
        for div_param in range(1,9):
            ...
            for function in functions:
                for reg_coef in reg_coefs:
                    ...
                    file_name=f"{model_name}_div_param_of_{div_param}_function_of_{function}_reg_coef_of_{reg_coef}_learningRateOf_{learning_rate}_momentumOf_{momentum}_weightDecayOf_{weight_decay}_gradientDescentMethodOf_{method_gradient_descent}_schedulerMethodOf_{method_scheduler}.csv"
                    ...
                    for rate in pruning_rate:
                        ...
                        torch.save(model_pruning.model.state_dict(),f"./{dataset}/model_{function}_reg_dif_para/"+f"{model_name}_div_param_of_{div_param}_function_of_{function}_reg_coef_of_{reg_coef}_learningRateOf_{learning_rate}_momentumOf_{momentum}_weightDecayOf_{weight_decay}_gradientDescentMethodOf_{method_gradient_descent}_schedulerMethodOf_{method_scheduler}.pt")
                        results_pruning.to_csv(f"./{dataset}/model_{function}_reg_dif_para/ThiNet_pruning_rate_{rate}_"+file_name)
                        ...
                        torch.save(results_pruning_retrained.model.state_dict(),f"./{dataset}/model_{function}_reg_dif_para/"+f"{model_name}_div_param_of_{div_param}_function_of_{function}_reg_coef_of_{reg_coef}_learningRateOf_{learning_rate}_momentumOf_{momentum}_weightDecayOf_{weight_decay}_gradientDescentMethodOf_{method_gradient_descent}_schedulerMethodOf_{method_scheduler}.pt")
